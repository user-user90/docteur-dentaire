      ...
      <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
        ...
        <div className="bg-cyan-600 p-6">
          <h1 className="text-2xl font-bold text-white flex items-center ">
            <span></span> Configuration du Hero
          </h1>
        ...
        <form action={updateDataHero} className="p-8 space-y-8">
          ...
          <div className="pt-4">
            <button 
              type="submit" 
              className="w-full bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-amber-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
            >
